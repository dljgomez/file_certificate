...
Generate a bare-bones class completion cerificate: printed,
...
if sys.version_info[0] == 2:
    ...
    import html
maxline = 60
browser = True                  # For seperator lines
saveto = 'Certificate.txt'      # Display in a browswer
template = ""                   # Output filenames
%sys
...
and is now entitled to privileges thereof, including
...
tags = tags.split('/n')                 # Line-by-line mods
tags = ['<p>' if line == ''
